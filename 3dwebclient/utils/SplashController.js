import { createCookie, getCookie, setCookie, addSplashWindowModel } from '../script.js';

document.addEventListener("DOMContentLoaded", function(event) {
    document.querySelector('#remove-splash-button').addEventListener('click', removeSplashWindow);
    document.querySelector('#add-splash-button').addEventListener('click', addSplashWindow);
    document.querySelector('#not_show_again_button').addEventListener('click', ignoreSplashWindow);
    document.querySelector('#close_button').addEventListener('click', closeSplashWindow);
});
...
export { insertSplashInfoHelp, getSplashWindowFromUrl };